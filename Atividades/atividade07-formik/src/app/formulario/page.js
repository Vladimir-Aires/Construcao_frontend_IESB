...
export default function Formulario() {
    ...
    function converter(dados){
        ...
        switch(dados.tipoMoeda){
            case 'dolar':
                resultConvert = dados.valorReal * 0.20;
                setMoeda('Dólar');
            break;
                    ...
                    >
                        {({values, handleChange, handleSubmit, handleReset}) => (
                            ...
                            <Form.Group className="my-2">
                                <Button className="me-2" variant="success" onClick={handleSubmit}> <FaMoneyBillTransfer /> Converter</Button>
                                <Button variant="secondary" onClick={handleReset}> <LuEraser /> Limpar</Button>
                            </Form.Group>
